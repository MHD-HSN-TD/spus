            ...
            <div>
                ...
                <div className="py-3 m-10 lg:mx-20  ">
                    ...
                    <div className="alert alert-warning mt-6">
                        ...
                        <span className="font-semibold">المعلومات الخاصة بأسعار الساعات لم تصدر لجميع الكليات حيث يتم تحديث المعلومات يومياً</span>
                        <p className="font-semibold">اخر  تحديث تم بتاريخ : <span dir="ltr">{date()}</span></p>
                    </div>
                </div>
                {/* table display */}
